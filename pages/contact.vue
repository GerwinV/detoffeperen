...
const faqs = [
    ...
    },
    {
        ...
        answer: 'De beste tijd om fruitbomen te planten is in het najaar (november-januari) of vroege voorjaar (maart-april). In deze periodes kunnen de bomen goed wortelen voordat het groeiseizoen begint.'
    }
]
